...
public class EntityRenderer implements IResourceManagerReloadListener
{
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                for (int i = 0; i < 8; ++i) {
                    ...
                    if (Client.moduleManager.getModule("CameraClip").isEnabled() || raytraceresult == null || !((d7 = raytraceresult.hitVec.distanceTo(new Vec3d(d0, d1, d2))) < d3)) continue;
                    d3 = d7;
                }
                if (this.mc.gameSettings.thirdPersonView == 2) {
    ...
    private void setupFog(int startCoords, float partialTicks)
    {
        ...
        /*
        if (Client.moduleManager.getModule("FogColor").isEnabled()){
            this.fogColorRed = new Color(Client.getColor(1)).getRed() / 255.0F;
            this.fogColorGreen = new Color(Client.getColor(1)).getGreen() / 255.0F;
            this.fogColorBlue = new Color(Client.getColor(1)).getBlue() / 255.0F;
        }
