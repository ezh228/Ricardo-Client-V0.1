...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public float lastReportedLegitYaw;
    /**
    ...
    public void onUpdate()
    {
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            if (this.isRiding())
            {
                ...
                EventUpdate eventUpdate = new EventUpdate(posX, axisalignedbb.minY, posZ, rotationYaw, rotationPitch, onGround);
                eventUpdate.call();
                this.connection.sendPacket(new CPacketPlayer.Rotation(eventUpdate.getRotationYaw(), eventUpdate.getRotationPitch(), eventUpdate.isOnGround()));
    ...
    private void onUpdateWalkingPlayer()
    {
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            double d0 = eventUpdate.getPosX() - this.lastReportedPosX;
            double d1 = eventUpdate.getPosY() - this.lastReportedPosY;
            double d2 = eventUpdate.getPosZ() - this.lastReportedPosZ;
            double d3 = (double)(eventUpdate.getRotationYaw()- this.lastReportedYaw);
            double d4 = (double)(eventUpdate.getRotationPitch() - this.lastReportedPitch);
            ...
            if (this.isRiding())
            {
                this.connection.sendPacket(new CPacketPlayer.PositionRotation(this.motionX, -999.0D, this.motionZ, eventUpdate.getRotationYaw(), eventUpdate.getRotationPitch(), eventUpdate.isOnGround()));
                flag2 = false;
            }
            else if (flag2 && flag3)
            {
                this.connection.sendPacket(new CPacketPlayer.PositionRotation(eventUpdate.getPosX(), eventUpdate.getPosY(), eventUpdate.getPosZ(), eventUpdate.getRotationYaw(), eventUpdate.getRotationPitch(), eventUpdate.isOnGround()));
            }
            else if (flag2)
            {
                this.connection.sendPacket(new CPacketPlayer.Position(eventUpdate.getPosX(), eventUpdate.getPosY(), eventUpdate.getPosZ(), eventUpdate.isOnGround()));
            }
            else if (flag3)
            {
                this.connection.sendPacket(new CPacketPlayer.Rotation(eventUpdate.getRotationYaw(), eventUpdate.getRotationPitch(), eventUpdate.isOnGround()));
            }
            else if (this.prevOnGround != eventUpdate.isOnGround())
            {
                this.connection.sendPacket(new CPacketPlayer(eventUpdate.isOnGround()));
            }

            if (flag2)
            {
                this.lastReportedPosX = eventUpdate.getPosX();
                this.lastReportedPosY = eventUpdate.getPosY();
                this.lastReportedPosZ = eventUpdate.getPosZ();
            ...
            this.prevOnGround = eventUpdate.isOnGround();
