...
public class GuiButton extends Gui
{
    ...
    public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_)
    {
        ...
        if (this.visible)
        {
            ...
            if (newStyle){
                int c = new Color(25, 25, 25).getRGB();
                RenderUtils.drawRoundedFullGradientShadowFullGradientRoundedFullGradientRectWithBloomBool(xPosition, yPosition, xPosition+width, yPosition+height, 5, 3, c, c, c, c, false, true, false);
            }else {
            ...
            if (newStyle){
                Fonts.main_18.drawCenteredString(this.displayString, this.xPosition + this.width / 2, this.yPosition + (this.height - 8) / 2, j);
