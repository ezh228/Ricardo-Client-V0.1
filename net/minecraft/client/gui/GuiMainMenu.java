...
{
    AnimationUtils xAnim = new AnimationUtils(0, 0, 0.01f);
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, j + 50+24, 98, 20, I18n.format("menu.options")).setNewStyle());
        this.buttonList.add(new GuiButton(4, this.width / 2 + 2, j + 50+24, 98, 20, I18n.format("menu.quit")).setNewStyle());
        //this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 124, j + 72 + 12).setNewStyle());
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        {
            //this.realmsButton = this.addButton(new GuiButton(14, this.width / 2 + 2, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format("menu.online").replace("Minecraft", "").trim()).setNewStyle());
            this.buttonList.add(this.modButton = new GuiButton(6, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format("fml.menu.mods")).setNewStyle());
        }
        else
        {
            //this.realmsButton = this.addButton(new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("menu.online")).setNewStyle());
        }
    }
    ...
    {
        this.buttonList.add(new GuiButton(11, this.width / 2 - 100, p_73972_1_, I18n.format("menu.playdemo")).setNewStyle());
        this.buttonResetDemo = this.addButton(new GuiButton(12, this.width / 2 - 100, p_73972_1_ + p_73972_2_ * 1, I18n.format("menu.resetdemo")).setNewStyle());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
         ...
         */
        int c = new Color(21, 20, 20).getRGB();
        RenderUtils.drawThemeRect(width/2-110, height/8+20, width/2+110, height/2+24);
        //RenderUtils.drawRoundedFullGradientShadowFullGradientRoundedFullGradientRectWithBloomBool(width/2-110, height/8-10, width/2+110, height/2, 5, 0, c, c, c, c,false, true, false);
