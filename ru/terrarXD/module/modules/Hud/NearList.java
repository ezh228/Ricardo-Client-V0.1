...
public class NearList extends HudModule {
    ArrayList<PlayerNear> mods = new ArrayList<>();
    AnimationUtils alpha = new AnimationUtils(0, 0, 0.1f);
    AnimationUtils size;
    public NearList() {
        super("NearList", Category.Hud, 120, 20);
    ...
    public void onEnable() {
        ...
        if (Client.moduleManager != null){
            for (Module module : Client.moduleManager.modules){
                if (module.getKey() != 0){
                    mods.add(new PlayerNear(module));
                }
            }
        }
    }
    ...
    public void onUpdate(EventUpdate event){
        if (mc.player.ticksExisted % 10 == 0){
            ...
            mods.sort(new Comparator<PlayerNear>() {
                @Override
                public int compare(PlayerNear o1, PlayerNear o2) {
    ...
    public class PlayerNear{
        ...
        AnimationUtils anim;
        public PlayerNear(EntityPlayer player){
            this.player = player;
