...
public class WaterMark extends HudModule {
    ...
    public void onRender2D(EventRender2D event){
        ...
        if (!Client.actual){
            text+=" устаревшая версия, обновись до последней тебе говорят!!!!!";
        }
        ...
        Fonts.main_18.drawString(Client.NAME_FULL.substring(1, Client.NAME_FULL.length())+" "+Client.VERSION + (Client.actual ? "" : " устаревшая версия, обновись до последней тебе говорят!!!!!"), x+8, y+7.5f-(Fonts.main_18.getHeight()/2), -1);
