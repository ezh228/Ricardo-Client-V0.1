...
/**
 * @author zTerrarxd_
 * @date 14.11.2023 18:50
 */
public class ShaderMainGui {
    private final int programId;
    private final int timeUniform;
    private final int mouseUniform;
    private final int resolutionUniform;

    public ShaderMainGui(String fragmentShaderLocation) throws IOException {
        int program = GL20.glCreateProgram();
        GL20.glAttachShader(program, this.createShader(ShaderMainGui.class.getResourceAsStream("/passthrough.vsh"), 35633));
        GL20.glAttachShader(program, this.createShader(ShaderMainGui.class.getResourceAsStream(fragmentShaderLocation), 35632));
